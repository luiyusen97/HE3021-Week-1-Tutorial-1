...
test_beta_3 <- t_test_2tail_variable_hypo(-10, 0.05, 1651, beta_3, 3.3330) # TRUE means insignificantly different from -10
...
```{r part_f, echo=TRUE}
test_beta_4 <- t_test_2tail_variable_hypo(100, 0.05, 1651, beta_3, 27.9757) # TRUE means insignificantly different from +100
